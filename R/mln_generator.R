...
#' mln1 <- mln_generator(directed = FALSE, row.label, probmat = probmats)
#'
...
#' probmat1[2,3] <- 0.03
#' probmats <- list(probmat1, probmat2, probmat2)
#' mln2 <- mln_generator(directed = TRUE, row.label, col.label, probmats)
#'

mln_generator <- function(directed = FALSE, row.label, col.label, probmat, sparse = TRUE) {
